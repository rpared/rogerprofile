...
let vfootprintBrand = document.getElementById("vfootprintbrand");
...
function dark_mode() {
  if (Mode == "light") {
    ...
    function changeLogos() {
      ...
      vfootprintBrand.src = "images/VFootprint-Brand_W.png";
    }
    changeLogos();
    ...
    function changeLogos() {
      ...
      vfootprintBrand.src = "images/VFootprint-Brand.png";
    }
    changeLogos();
